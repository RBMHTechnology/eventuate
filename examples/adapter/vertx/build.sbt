...
name := "eventuate-vertx-adapter-example"
...
libraryDependencies ++= Seq(
  ...
  "io.javaslang"              %  "javaslang"                % "2.0.5" withSources(),
  "io.vertx"                  %  "vertx-core"               % vrtxVer withSources(),
  "io.vertx"                  %  "vertx-rx-java"            % vrtxVer withSources(),
