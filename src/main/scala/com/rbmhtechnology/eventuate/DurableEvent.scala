 ...
 * @param replicaId Replica id of emitter ([[EventsourcedActor]]).
 * @param sourceAggregateId Aggregate id of emitter ([[EventsourcedActor]]).
...
case class DurableEvent(
  ...
  replicaId: String,
  sourceAggregateId: Option[String] = None,
  ...
  def processId: String =
    DurableEvent.processId(replicaId, sourceAggregateId)
