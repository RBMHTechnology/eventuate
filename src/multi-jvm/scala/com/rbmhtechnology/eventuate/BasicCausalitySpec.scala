...
class BasicCausalitySpecLeveldb extends BasicCausalitySpec with MultiNodeSupportLeveldb
...
class BasicCausalitySpecCassandra extends BasicCausalitySpec with MultiNodeSupportCassandra {
...
object BasicCausalityConfig extends MultiNodeConfig {
...
abstract class BasicCausalitySpec extends MultiNodeSpec(BasicCausalityConfig) with MultiNodeWordSpec with MultiNodeReplicationEndpoint {
  import BasicCausalityConfig._
