...
**Please note:** Documentation is currently being re-written and moved to [its new location](http://rbmhtechnology.github.io/eventuate/). The following sections have already been moved:
 
- [Introduction](http://rbmhtechnology.github.io/eventuate/introduction.html)
- [Architecture](http://rbmhtechnology.github.io/eventuate/architecture.html) (new)
- [Appendix](http://rbmhtechnology.github.io/eventuate/appendix.html)

The following sections will be updated soon to become the new [reference guide](http://rbmhtechnology.github.io/eventuate/ref-guide.html).  
