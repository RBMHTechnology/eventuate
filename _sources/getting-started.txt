...
If you want to know more, read the :ref:`user-guide`. It cover’s Eventuate’s main features and shows API usage examples. Although the user guide is a not a step-by-step tutorial, there’s enough information for creating your first Eventuate application.
